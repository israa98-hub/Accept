...
def account():
    ...
    def sign_up():
        ...
        Label(frame, text=lang.a, bg=bg, fg=fg, font='tahoma 20').grid(row=0, column=0)
        Label(frame, text=lang.id, bg=bg, fg=fg, font='tahoma 20').grid(row=1, column=0)
        Label(frame, text=lang.b, bg=bg, fg=fg, font='tahoma 20').grid(row=2, column=0)
        Label(frame, text=lang.c, bg=bg, fg=fg, font='tahoma 20').grid(row=3, column=0)
        Label(frame, text=lang.d, bg=bg, fg=fg, font='tahoma 20').grid(row=4, column=0)
        Label(frame, text=lang.gin, bg=bg, fg=fg, font='tahoma 20').grid(row=5, column=0)
        Label(frame, text=lang.e, bg=bg, fg=fg, font='tahoma 20').grid(row=6, column=0)
        Label(frame, text=lang.f, bg=bg, fg=fg, font='tahoma 20').grid(row=7, column=0)
        Label(frame, text=lang.g, bg=bg, fg=fg, font='tahoma 20').grid(row=8, column=0)
        Label(frame, text=lang.jj, bg=bg, fg=fg, font='tahoma 20').grid(row=9, column=0)
        ...
        txtgender = ttk.Combobox(frame, values=(lang.male,lang.female), font='tahoma 10',textvariable=svgender, state='readonly')
    ...
    def funcDeleteBoard():
        ...
        isShow.forget()
        isShow=Frame(frm)
        Label(isShow, text=lang.dddd, font='tahoma 20').grid(row=2, column=1)
        Entry(isShow, bg="white", fg=fg, font='tahoma 20', textvariable=svbord).grid(row=3, column=1)
        Button(isShow, text=lang.DeBo, bg="white", height="3", width="10", font="10", command=lambda: delete_board(svbord.get())).grid(
            row=4, column=1, padx=5, pady=80)
        Button(isShow, text=lang.back, bg="white", height="3", width="10", font="10", command=allboards).grid(
            row=4, column=0, padx=5, pady=80)
        isShow.pack()
